                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <div class="flex flex-col mt-8">
                        <div class="py-2 -my-2 overflow-x-auto sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8">
                            <a href="{{ route('product.create') }}" class="bg-green-600 hover:bg-green-500 float-right text-white font-bold mb-5 py-2 px-4 rounded">
                                Create Product
                            </a>
                            <a href="{{ route('product.create') }}" class="bg-blue-600 hover:bg-blue-500 float-right text-white font-bold mb-5 py-2 px-4 mr-3 rounded">
                                Create Category
                            </a>
                                        ...
                                        @if($products->count() < 1)
                                            <tr>
                                                <td colspan="6" class="text-center">
                                                    <div for="" class="my-5 font-bold">There Is No Any Product</div>
                                                </td>
                                            </tr>
                                        @else
                                            ...
                                            <tr>
                                                ...
                                                <td
                                                    ...
                                                    <a href="{{ route('product.edit',$product) }}"><svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 text-blue-400" fill="none"
